...
### 2. File di Configurazione (ital8Config.json5)
...
2. `logLevel` in ital8Config.json5
3. `debugMode` in ital8Config.json5 (se = 1, usa DEBUG)
4. Default: INFO
...
2. Controlla ital8Config.json5 per `logLevel` o `debugMode`
