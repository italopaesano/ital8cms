...
- [`cli-control-plane.it.md`](./cli-control-plane.it.md) — control plane CLI (`ital8cms-cli`): pilotare un'istanza in esecuzione via SSH (attivare/disattivare l'area admin, manutenzione del sito pubblico, reset config)
