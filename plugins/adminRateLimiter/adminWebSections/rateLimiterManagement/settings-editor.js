...
/**
 * settings-editor.js — editor JSON5 del blocco "custom" di pluginConfig.json5
 * (tab Impostazioni). Carica (/config), valida (/validate-config), salva (/config:
 * valida server-side, backup, editJson5 del solo blocco custom, reloadConfig).
 * "Salva e riavvia" salva e poi chiama /restart (i blocchi attivi persistono).
 */
(function () {
  'use strict';
