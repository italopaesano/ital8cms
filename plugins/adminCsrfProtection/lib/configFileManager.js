/**
 * configFileManager.js — operazioni filesystem per adminCsrfProtection.
 *
 * Legge/scrive il file di configurazione del plugin di servizio `csrfProtection`
 * (pluginConfig.json5) con scrittura atomica e backup a rotazione. NON contiene
 * logica di validazione: quella è riusata dal `csrfProtection` tramite l'oggetto
 * condiviso (validateConfig).
 */
